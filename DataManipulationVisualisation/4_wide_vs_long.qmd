---
title: "4 Wide vs long format, summarise"
...
<!--add advanced mutate with by from the chapter 5 joins  -->

<!--add advanced summarise from the chapter 5 joins /  just a selection and coomunity weighted means - move maybe to the chapter 10,  -->
...
![](images/clipboard-1752338144.png)
...
9\. We will switch to another dataset, **Species Forest Data** - `Axmanova-Forest-spe.xlsx`. This is a long-format of the plant species recorded in the vegetation plots. Long format means that the records of species from one site are grouped by the same ID (here, RELEVE_NR). For each species, it is indicated in which vegetation layer it occurred, and an estimation of its abundance is in the form of percentage cover.
