...
7.  (Real-world example for botanists) Use the data from the folder `basiphilous_grasslands` and recreate the following plot:
...
8.  Save all plots you created so far to the `plots` folder.
