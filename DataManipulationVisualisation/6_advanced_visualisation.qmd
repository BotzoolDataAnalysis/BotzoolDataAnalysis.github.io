...
We will again use the penguin dataset and play with the individual plot parts. In addition we will use some other packages, so please make sure you have them installed and leaded.
...
-   [`gordi`](https://github.com/Kryshtoson/gordi/tree/main) a ggplot-based package for making ordination plots, developed in our group
...
5.  Use the dataset `Axmanova-Forest-understory-diversity-analyses.xlsx` from the folder `forest_understory` ([Link to the Github folder](https://github.com/BotzoolDataAnalysis/BotzoolDataAnalysis.github.io/tree/main/DataManipulationVisualisation/data)) and recreate the following plot:
