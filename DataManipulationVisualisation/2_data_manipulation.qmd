...
You can also filter plots in a specified range of some value and use
multiple conditions. Here I want to keep only plots that have biomass in
the range 40-80 g/m2 but if there are any plots without any value (NA),
I want to keep them as well.
...
plots from the specified to types and from the others we take just those
that have higher biomass because we used OR (\|) between the two
conditions.
