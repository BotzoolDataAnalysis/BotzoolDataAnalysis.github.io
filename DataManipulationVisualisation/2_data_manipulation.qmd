...
2\. Directly from R studio create folder "resultsChapter2" for saving todays datasets, as we will train a bit of exporting the data. 


3\. Use the Forest Data to train more. Create variable "author" which will contain name Axmanova > as we did before, create variable richness summing the herbs and juveniles > select variables plotID, author, richness, productivity (renamed biomass) and pH. Try to save this subset into resultsChapter2.
