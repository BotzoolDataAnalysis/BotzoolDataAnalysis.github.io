...
First of all , GitHub is a huge repository of open-source code and data. Many researchers collaborate on their analyses through GitHub and publish their data and code associated with their scientific articles there. You can also find many R packages there. You can browse the resources published there even without a GitHub account. Open the GitHub main page ([https://github.com](https://github.com)) and in the top right corner, you will find a search box. You can search for repositories, users, packages... You can try find our personal accounts by typing our names in the search box. Next, you can try to find the repository with the code for this website by searching for 'BotzoolDataAnalysis'.

In some published studies using an R code for the analysis, you might find a link to the GitHub repository with the code in the Data Methods section or in the Data Availability Statement. You can find an example of such repository storing code from a published article here: [https://github.com/klaraklink/SMor_semi-dry_grass_change](https://github.com/klaraklink/SMor_semi-dry_grass_change). You can check the structure of the repository and read more about the data in the README. 

You can not only look at the code online, but also download the whole repository to your computer by clicking on the green button '\<\> Code' and then 'Download ZIP'.

![](images/github_download.png){fig-align="center"}

## 12.3 Set up your own account

For other operations with GitHub, e.g., creating your own version control repository, collaborating on the analysis with others, or publishing code from a paper, you will need to create your own GitHub account. We will now go through the setup together. 
...
Go to [https://github.com](https://github.com/) and log in. You might see something like this:
...
## 12.9 Time travel
One of the advantages of the version control system is, that you can look back in the history of your repository and see, what changes happened at which stage of the project etc. To see the previous commits in the R Studio, click on 'History' in the Git pane. You will see something like this:

![](images/github_history.png)
You can check the changes made in each commit by clicking on it.

Similarly, you can check the history of the remote repository on the GitHub webpage by clicking on 'Commits'.

![](images/github_history_remote.png)

When something goes wrong, you can always return to a previous version of your code. However, be careful when doing that, especially if you are collaborating with others. Look [here](https://happygitwithr.com/flight-rules.html) for some tips on how to get out of terrible situations.
...
- You can use **private** repositories for work in progress which includes data and scripts that are not published yet and you don't want to make them public, e.g., before publishing a scientific paper based on the analysis. 
